...
<main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
       <div class="col-md-12">
          <a href="{{route('Product_create')}}"><button style="float: right;" type="button" class="btn btn-info float-right m-2">Add</button></a>
       </div>
              ...
              <table class="table" style="">
                ...
                <tr style="margin-top: 5px">
                  ...
                  <td><b>{{optional($data->category)->name_category}}</b></td>
                   <td><b>{{optional($data->brand)->name_brand}}</b></td>  {{-- optional khi id_brand không tồn tại giá trị sẽ rỗng --}}
                   <td>{{$data->qty}}</td>
                  <td >
